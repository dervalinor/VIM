...
" Ctrl+w <: Reduce el ancho de la ventana actual.
...
" New theme of course of vim udemy
Plug 'morhetz/gruvbox'
Plug 'easymotion/vim-easymotion'
"navigation between files
Plug 'christoomey/vim-tmux-navigator'

"easymotion create command for activate
let mapleader=" "
nmap <leader>s <Plug>(easymotion-s2)

"exit NERDTree after of used
let NERDTreeQuitOnOpen=1

"Create shortcut, CR is ENTER
"Command :w
nmap <leader>w :w<CR>
":q
nmap <leader>q :q<CR>
